...
const UI = {
  ...
  'nav.prophetfamily':  { en: 'Family Tree',        ms: 'Salasilah',       tur: 'Aile Ağacı',             urd: 'شجرہ نسب',         ben: 'বংশলতিকা',           fas: 'شجره خانوادگی', zh: '家族谱系',      yue: '家族譜系',     ja: '家系図',          ru: 'Родословие',           es: 'Árbol familiar',     ko: '가계도',              ta: 'குடும்ப மரம்',    si: 'පවුල් රුක'        },
  'nav.janazah':        { en: 'Funeral Prayer',     ms: 'Solat Jenazah',   tur: 'Cenaze Namazı',           urd: 'نمازِ جنازہ',      ben: 'জানাজার নামাজ',       fas: 'نماز جنازه',    zh: '殡礼',          yue: '殯禮',         ja: '葬儀の礼拝',      ru: 'Джаназа',              es: 'Oración fúnebre',    ko: '장례 예배',           ta: 'ஜனாஸாத் தொழுகை',   si: 'ජනාසා නමස්කාරය'   },
  'nav.salawats':       { en: 'Other Prayers',      ms: 'Solat Lain',      tur: 'Diğer Namazlar',          urd: 'دیگر نمازیں',      ben: 'অন্যান্য নামাজ',      fas: 'سایر نمازها',   zh: '其他拜功',      yue: '其他拜功',     ja: 'その他の礼拝',    ru: 'Другие молитвы',       es: 'Otras oraciones',    ko: '기타 예배',           ta: 'மற்ற தொழுகைகள்',  si: 'අනෙකුත් සලාත්'    },
  ...
  'nav.afterlife':      { en: 'Life After Death',   ms: 'Kehidupan Selepas Mati', tur: 'Ahiret Hayatı',    urd: 'موت کے بعد کی زندگی', ben: 'মৃত্যু-পরবর্তী জীবন',  fas: 'حیات پس از مرگ', zh: '死后生命',      yue: '死後生命',     ja: '死後の生',        ru: 'Жизнь после смерти',   es: 'La vida después',    ko: '사후의 삶',           ta: 'மரணத்திற்குப் பின்', si: 'මරණයෙන් පසු ජීවිතය' },
  'nav.angels':         { en: 'The Angels',         ms: 'Para Malaikat',   tur: 'Melekler',                urd: 'فرشتے',             ben: 'ফেরেশতাগণ',          fas: 'فرشتگان',       zh: '众天使',        yue: '眾天使',       ja: '天使たち',        ru: 'Ангелы',               es: 'Los Ángeles',        ko: '천사들',              ta: 'மலக்குகள்',       si: 'දේවදූතයන්'        },
  'nav.jinn':           { en: 'The Jinn',           ms: 'Jin',             tur: 'Cinler',                  urd: 'جن',                ben: 'জিনগণ',              fas: 'جنّیان',        zh: '精灵',          yue: '精靈',         ja: 'ジンたち',        ru: 'Джинны',               es: 'Los Yinn',           ko: '진(정령)들',          ta: 'ஜின்கள்',         si: 'ජින්නයන්'         },
  'nav.endtimes':       { en: 'Signs of the Hour',  ms: 'Tanda-Tanda Kiamat', tur: 'Kıyamet Alametleri',  urd: 'قیامت کی نشانیاں', ben: 'কিয়ামতের নিদর্শন',    fas: 'نشانه‌های قیامت',zh: '末日征兆',      yue: '末日徵兆',     ja: '審判の徴',        ru: 'Знамения Часа',        es: 'Signos de la Hora',  ko: '시간의 징표',         ta: 'மறுமை அடையாளங்கள்', si: 'අන්තිම දිනයේ සලකුණු' },
  'nav.dajjal':         { en: 'The Dajjal',         ms: 'Dajjal',          tur: 'Deccâl',                  urd: 'دجال',              ben: 'দাজ্জাল',              fas: 'دجال',          zh: '达贾利',        yue: '達賈利',       ja: 'ダッジャール',    ru: 'Даджаль',              es: 'El Dayyal',          ko: '앗다잘',              ta: 'தஜ்ஜால்',         si: 'දජ්ජාල්'          },
  'nav.yajujmajuj':     { en: "Ya'juj and Ma'juj",  ms: "Ya'juj dan Ma'juj", tur: "Ye'cûc ve Me'cûc",     urd: 'یاجوج و ماجوج',    ben: 'ইয়াজুজ ও মাজুজ',      fas: 'یأجوج و مأجوج', zh: '雅朱者与马朱者',yue: '雅朱者與馬朱者',ja: 'ヤアジュージュとマアジュージュ', ru: 'Йаджудж и Маджудж', es: "Ya'yuy y Ma'yuy",    ko: '야주즈와 마주즈',     ta: 'யஃஜூஜ் மற்றும் மஃஜூஜ்', si: 'යාජූජ් හා මාජූජ්' },
  ...
  'nav.masjidetiquette':{ en: 'Masjid Etiquette',   ms: 'Adab Masjid',     tur: 'Mescid Adabı',            urd: 'آدابِ مسجد',        ben: 'মসজিদের আদব',        fas: 'آداب مسجد',     zh: '清真寺礼节',    yue: '清真寺禮節',   ja: 'モスクの作法',   ru: 'Этикет мечети',        es: 'Modales en la Mezquita', ko: '마스지드 예절',      ta: 'மஸ்ஜித் ஒழுக்கம்', si: 'මස්ජිද් සිරිත්'    },
  'nav.propheticmedicine':{ en: 'Prophetic Medicine', ms: 'Perubatan Nabawi', tur: 'Tıbb-ı Nebevi',       urd: 'طبِ نبوی',          ben: 'নববী চিকিৎসা',     fas: 'طب نبوی',       zh: '先知医学',      yue: '先知醫學',     ja: '預言者の医学',   ru: 'Пророческая медицина', es: 'Medicina Profética',  ko: '예언자의 의학',      ta: 'நபிமருத்துவம்',   si: 'නබි වෛද්‍ය විද්‍යාව' },
  'nav.toilet':         { en: 'Toilet Etiquette',   ms: 'Adab Tandas',     tur: 'Tuvalet Adabı',           urd: 'آدابِ بیت الخلا',   ben: 'শৌচাগারের আদব',     fas: 'آداب دستشویی',  zh: '如厕礼节',      yue: '如廁禮節',     ja: '厠の作法',      ru: 'Этикет туалета',       es: 'Modales del Baño',    ko: '화장실 예절',        ta: 'கழிப்பறை ஒழுக்கம்', si: 'වැසිකිළි සිරිත්'  },
  'nav.sleep':          { en: 'Sleep Etiquette',    ms: 'Adab Tidur',      tur: 'Uyku Adabı',              urd: 'آدابِ خواب',        ben: 'নিদ্রার আদব',        fas: 'آداب خواب',     zh: '睡眠礼节',      yue: '睡眠禮節',     ja: '就寝の作法',    ru: 'Этикет сна',           es: 'Modales al Dormir',   ko: '수면 예절',          ta: 'உறக்க ஒழுக்கம்',   si: 'නින්දේ සිරිත්'    },
  'nav.clothing':       { en: 'Clothing Etiquette', ms: 'Adab Berpakaian', tur: 'Giyim Adabı',             urd: 'آدابِ لباس',        ben: 'পোশাকের আদব',        fas: 'آداب پوشش',     zh: '衣着礼节',      yue: '衣著禮節',     ja: '衣服の作法',    ru: 'Этикет одежды',        es: 'Modales del Vestir',  ko: '의복 예절',          ta: 'ஆடை ஒழுக்கம்',     si: 'ඇඳුම් සිරිත්'     },
  'nav.ahkam':          { en: 'The Five Ahkam',     ms: 'Lima Ahkam',      tur: 'Beş Ahkâm',              urd: 'پانچ احکام',        ben: 'পাঁচ আহকাম',        fas: 'پنج احکام',     zh: '五大教法判决',  yue: '五大教法判決', ja: '五つのアフカーム', ru: 'Пять ахкам',           es: 'Los Cinco Ahkam',     ko: '다섯 아흐캄',         ta: 'ஐந்து அஹ்காம்',   si: 'පස් අහ්කාම්'      },
  'nav.dhabihah':       { en: 'Halal Slaughter',    ms: 'Sembelihan Halal', tur: 'Helâl Kesim',           urd: 'حلال ذبح',           ben: 'হালাল যবাই',        fas: 'ذبح حلال',      zh: '合法宰牲',      yue: '合法宰牲',     ja: 'ハラール屠畜',   ru: 'Халяльный забой',      es: 'Sacrificio Halal',    ko: '할랄 도축',          ta: 'ஹலால் அறுத்தல்',  si: 'හලාල් කැපීම'      },
  'nav.eating':         { en: 'Eating Etiquette',   ms: 'Adab Makan',      tur: 'Yeme Adabı',              urd: 'آدابِ طعام',        ben: 'খাদ্যাভ্যাসের আদব', fas: 'آداب خوردن',    zh: '饮食礼节',      yue: '飲食禮節',     ja: '食事の作法',    ru: 'Этикет еды',           es: 'Modales al Comer',    ko: '식사 예절',          ta: 'உண்ணும் ஒழுக்கம்', si: 'ආහාර සිරිත්'      },
  'nav.prohibitedclothing':{ en: 'Prohibited Clothing', ms: 'Pakaian Terlarang', tur: 'Yasak Giyim',      urd: 'ممنوعہ لباس',       ben: 'নিষিদ্ধ পোশাক',      fas: 'لباس ممنوع',    zh: '禁止之衣',      yue: '禁止之衣',     ja: '禁じられた衣服', ru: 'Запретная одежда',     es: 'Vestir Prohibido',    ko: '금지된 의복',        ta: 'தடைசெய்யப்பட்ட ஆடை', si: 'තහනම් ඇඳුම්'   },
  ...
  'ui.comingsoon':  { en: 'In Development',  ms: 'Dalam Pembangunan', tur: 'Geliştiriliyor',   urd: 'زیرِ تیاری',       ben: 'উন্নয়নাধীন',   fas: 'در دست تدوین',      zh: '开发中',      yue: '開發中',       ja: '開発中',          ru: 'В разработке',         es: 'En desarrollo',      ko: '개발 중',             ta: 'உருவாக்கத்தில்',    si: 'සංවර්ධනය වෙමින්'  },
  ...
  /* ── Sahaba (Companions of the Prophet) nav label ── */
  'nav.sahaba': {
    en: "The Sahaba", ms: "Sahabat Nabi", tur: "Sahabe", urd: 'صحابہ',
    ben: 'সাহাবীগণ', fas: 'صحابه', zh: '圣门弟子', yue: '聖門弟子',
    ja: '教友', ru: 'Сподвижники', es: "Los Compañeros", ko: '사하바',
  ...
  'nav.prophetwars': {
    ...
    ben: 'নবীদের যুদ্ধ', fas: 'جنگ‌های پیامبران', zh: '先知的战争', yue: '先知嘅戰爭',
    ja: '預言者の戦い', ru: 'Войны пророков', es: 'Guerras de los profetas', ko: '예언자들의 전쟁',
    ta: 'நபிமார்களின் போர்கள்', si: 'නබිවරුන්ගේ යුද්ධ',
  },

  /* ── Site highlights section (home page) ─────────────────── */
  'stats.heading': { en: `A Complete Library of Islamic Knowledge`, ms: `Sebuah Perpustakaan Lengkap Ilmu Islam`, tur: `Kapsamlı Bir İslami Bilgi Kütüphanesi`, urd: `اسلامی علم کی مکمل کتب خانہ`, ben: `ইসলামি জ্ঞানের একটি পূর্ণাঙ্গ গ্রন্থাগার`, fas: `کتابخانه‌ای کامل از دانش اسلامی`, zh: `伊斯兰知识的完整宝库`, yue: `伊斯蘭知識嘅完整寶庫`, ja: `イスラム知識の総合図書館`, ru: `Полная библиотека исламских знаний`, es: `Una biblioteca completa del conocimiento islámico`, ko: `이슬람 지식의 완전한 도서관`, ta: `இஸ்லாமிய அறிவின் முழுமையான நூலகம்`, si: `ඉස්ලාමීය දැනුමේ සම්පූර්ණ පුස්තකාලයක්` },
  'stats.sub': { en: `Every essential branch of Islamic learning, cross-referenced and translated  –  from the words of the Prophet ﷺ, the wisdom of the Companions, and the scholarship of the ages.`, ms: `Setiap cabang penting ilmu Islam, dirujuk silang dan diterjemahkan  –  daripada sabda Nabi ﷺ, hikmah para Sahabat, dan kesarjanaan zaman berzaman.`, tur: `İslami öğrenimin her temel dalı, çapraz referanslı ve tercüme edilmiş  –  Peygamber ﷺ'in sözlerinden, sahabelerin hikmetinden ve çağların ilminden.`, urd: `اسلامی علم کی ہر بنیادی شاخ، حوالہ جاتی طور پر مربوط اور ترجمہ شدہ  –  نبی ﷺ کے اقوال، صحابہ کی حکمت، اور صدیوں کی علمی وراثت سے۔`, ben: `ইসলামি শিক্ষার প্রতিটি মূল শাখা, ক্রস-রেফারেন্স করা ও অনুবাদিত  –  নবী ﷺ-এর বাণী, সাহাবাগণের প্রজ্ঞা এবং যুগের পণ্ডিতদের গবেষণা থেকে।`, fas: `هر شاخه‌ی اصلی از فراگیری اسلامی، با ارجاعات متقابل و ترجمه شده  –  از سخنان پیامبر ﷺ، حکمت اصحاب و پژوهش‌های علمی اعصار.`, zh: `伊斯兰学问的每一个核心分支，交叉参照并翻译  –  源自先知ﷺ的话语、圣门弟子的智慧与历代学术。`, yue: `伊斯蘭學問嘅每一個核心分支，交叉參照並翻譯  –  源自先知ﷺ嘅話語、聖門弟子嘅智慧與歷代學術。`, ja: `イスラム学のあらゆる基本分野を、相互参照し翻訳して収録  –  預言者ﷺの言葉、教友たちの叡智、そして時代を超えた学問から。`, ru: `Каждая существенная ветвь исламского знания, перекрёстно связанная и переведённая  –  из слов Пророка ﷺ, мудрости сподвижников и учёности веков.`, es: `Cada rama esencial del saber islámico, referenciada de forma cruzada y traducida  –  desde las palabras del Profeta ﷺ, la sabiduría de los Compañeros y la erudición de las eras.`, ko: `이슬람 학문의 모든 핵심 분과를 상호 참조하고 번역했습니다  –  예언자 ﷺ의 말씀, 교우들의 지혜, 그리고 시대의 학문으로부터.`, ta: `இஸ்லாமிய கல்வியின் ஒவ்வொரு அடிப்படை பிரிவும், ஒன்றுடன் ஒன்று இணைத்து மொழிபெயர்க்கப்பட்டவை  –  நபி ﷺ அவர்களின் வார்த்தைகள், தோழர்களின் ஞானம் மற்றும் காலங்களின் அறிஞர்களிடமிருந்து.`, si: `ඉස්ලාමීය අධ්‍යාපනයේ සෑම මූලික අංශයක්ම, හරස්-යොමු කර පරිවර්තනය කර ඇත  –  නබි ﷺ තුමාගේ වචන, සහාබිවරුන්ගේ ප්‍රඥාව, සහ යුගවල විද්වත්තාවෙන්.` },
  'stats.languages': { en: `Languages`, ms: `Bahasa`, tur: `Dil`, urd: `زبانیں`, ben: `ভাষা`, fas: `زبان`, zh: `语言`, yue: `語言`, ja: `言語`, ru: `Языков`, es: `Idiomas`, ko: `언어`, ta: `மொழிகள்`, si: `භාෂා` },
  'stats.surahs': { en: `Surahs with meaning in every language`, ms: `Surah dengan maksud dalam setiap bahasa`, tur: `Anlamı her dilde verilen sûre`, urd: `ہر زبان میں معنی سمیت سورتیں`, ben: `প্রতিটি ভাষায় অর্থসহ সূরাসমূহ`, fas: `سوره‌ها همراه با معنا در همه‌ی زبان‌ها`, zh: `每种语言均附意义的章`, yue: `每種語言均附意義嘅章`, ja: `各言語で意味を付した各章`, ru: `Сур с переводом на каждый язык`, es: `Suras con significado en cada idioma`, ko: `모든 언어로 의미가 있는 수라`, ta: `ஒவ்வொரு மொழியிலும் பொருள் கொண்ட சூராக்கள்`, si: `සෑම භාෂාවකින්ම අර්ථ සහිත සූරා` },
  'stats.prophets': { en: `Prophets covered with lineage, stories, and family`, ms: `Nabi diliputi dengan nasab, kisah, dan keluarga`, tur: `Nesep, kıssa ve aileleriyle ele alınan peygamber`, urd: `نسب، قصص، اور خاندان کے ساتھ انبیاء کا احاطہ`, ben: `বংশধারা, কাহিনি ও পরিবারসহ কভার করা নবীগণ`, fas: `پیامبران با نسب، داستان‌ها و خانواده پوشش داده شده`, zh: `涵盖世系、故事与家族的先知`, yue: `涵蓋世系、故事同家族嘅先知`, ja: `系譜・物語・家族と共に扱われた預言者`, ru: `Пророков с родословной, историями и семьёй`, es: `Profetas cubiertos con linaje, historias y familia`, ko: `계보, 이야기, 가족과 함께 다룬 예언자`, ta: `பரம்பரை, கதைகள் மற்றும் குடும்பத்துடன் விவரிக்கப்பட்ட நபிமார்கள்`, si: `පරම්පරාව, කථා සහ පවුල් සමඟ ආවරණය කළ නබිවරු` },
  'stats.duas': { en: `Authentic supplications with source and story`, ms: `Doa yang sahih dengan sumber dan kisah`, tur: `Kaynak ve arka planıyla sahih dualar`, urd: `مآخذ اور کہانی سمیت مستند دعائیں`, ben: `উৎস ও প্রেক্ষাপটসহ প্রামাণিক দোয়াসমূহ`, fas: `دعاهای صحیح با منبع و پیش‌زمینه`, zh: `附来源与故事的真实祈祷词`, yue: `附來源同故事嘅真實祈禱詞`, ja: `出典と背景を添えた真正の祈願`, ru: `Достоверных мольб с источником и историей`, es: `Súplicas auténticas con fuente e historia`, ko: `출처와 이야기가 함께 있는 진정한 두아`, ta: `மூலாதாரம் மற்றும் கதையுடன் நம்பகமான துஆக்கள்`, si: `මූලාශ්‍රය සහ කථාව සමඟ අව්‍යාජ දුආ` },
  'stats.hadith': { en: `Major Hadith collections searchable in your language`, ms: `Koleksi Hadis utama boleh dicari dalam bahasa anda`, tur: `Kendi dilinizde aranabilir başlıca hadis külliyatı`, urd: `آپ کی زبان میں تلاش کے قابل بڑے مجموعات حدیث`, ben: `আপনার ভাষায় অনুসন্ধানযোগ্য প্রধান হাদিস সংকলন`, fas: `مجموعه‌های اصلی حدیث با قابلیت جست‌وجو در زبان شما`, zh: `可用您语言检索之主要圣训集`, yue: `可用你語言檢索之主要聖訓集`, ja: `お使いの言語で検索できる主要ハディース集`, ru: `Крупнейших сборников хадисов с поиском на вашем языке`, es: `Colecciones principales de Hadith con búsqueda en tu idioma`, ko: `귀하의 언어로 검색 가능한 주요 하디스 컬렉션`, ta: `உங்கள் மொழியில் தேடக்கூடிய முக்கிய ஹதீஸ் தொகுப்புகள்`, si: `ඔබේ භාෂාවෙන් සෙවිය හැකි ප්‍රධාන හදීස් එකතු` },
  'stats.companions': { en: `Companions, Followers, and later Imams with biographies`, ms: `Sahabat, Tabi'in dan para Imam kemudian dengan biografi`, tur: `Biyografileri ile sahabîler, tâbiîler ve sonraki imamlar`, urd: `سیرت کے ساتھ صحابہ، تابعین اور بعد کے ائمہ`, ben: `জীবনীসহ সাহাবী, তাবি'ঈন ও পরবর্তী ইমামগণ`, fas: `اصحاب، تابعین و ائمه‌ی متأخر با شرح حال`, zh: `附传记之圣门弟子、随行者与后世伊玛目`, yue: `附傳記之聖門弟子、隨行者與後世伊瑪目`, ja: `伝記付きの教友、後継者、後の諸イマーム`, ru: `Сподвижников, последователей и поздних имамов с биографиями`, es: `Compañeros, Seguidores e Imames posteriores con biografías`, ko: `전기와 함께한 교우, 그 후예, 그리고 후대 이맘들`, ta: `வாழ்க்கை வரலாற்றுடன் தோழர்கள், தோழர்களைப் பின்பற்றியவர்கள் மற்றும் பிற்கால இமாம்கள்`, si: `චරිතාපදාන සමඟ සහාබිවරු, තාබිඊන්වරු සහ පසුව සිටි ඉමාම්වරු` },
} as const;
